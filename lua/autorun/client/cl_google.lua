...
hook_Add("OnPlayerChat", "OnPlayerChat_Google", function(ply, text, teamchat, dead, prefix)
	if !IsValid(ply) or !GoogleBool:GetBool() or (prefix and prefix ~= ply:Name()) then return end
